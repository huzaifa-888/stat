    ...
    <div className="mx-auto max-w-content px-6 py-14">
      ...
      <div className="mt-8 grid gap-10 lg:grid-cols-[1.6fr_1fr]">
        <div className="space-y-4">
          {items.map((item) => (
            <div key={item.id} className="flex items-center justify-between gap-4 rounded-2xl border border-line bg-white p-5">
              <div>
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="focus-ring text-sm text-navy/40 hover:text-red-500"
        ...
        <div className="h-fit rounded-3xl border border-line bg-white p-6">
          ...
          <Link
            href="/checkout"
            className="focus-ring mt-5 block rounded-pill bg-cyan py-3.5 text-center text-sm font-semibold text-white hover:bg-cyan-deep"
          >
            Proceed to checkout
          </Link>
        </div>
